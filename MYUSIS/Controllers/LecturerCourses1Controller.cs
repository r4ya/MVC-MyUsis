...
{
    public class LecturerCourses1Controller : Controller
    {
        private usis db = new usis();

        // GET: LecturerCourses1
        ...
        // GET: LecturerCourses1/Details/5
        ...
        // POST: LecturerCourses1/Delete/5
