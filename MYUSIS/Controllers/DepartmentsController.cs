...
namespace MYUSIS.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DepartmentID,DepartmenName,FacultyID")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DepartmentID,DepartmenName,FacultyID")] Department department)
        {
            if (ModelState.IsValid)
            {
