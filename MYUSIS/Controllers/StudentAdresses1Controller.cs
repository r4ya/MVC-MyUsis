...
{
    public class StudentAdresses1Controller : Controller
    {
        private usis db = new usis();

        // GET: StudentAdresses1
        ...
        // GET: StudentAdresses1/Details/5
        ...
        // POST: StudentAdresses1/Delete/5
